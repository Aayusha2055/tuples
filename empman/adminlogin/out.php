...
<div class="panel panel-info" style="margin-left: 100px; margin-right: 1100px;" >
    <div class="panel-body">
        ...
        if (mysqli_fetch_row($result)>0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $status = $row['status'];
                if ($username == $_SESSION['user_name']) {
                    echo '<h4 class="text" style="font-size: small; color: red"> Hello ' . $username . '</h4>';
                }
            }
        }
        ?>
    ...
    <div class="panel-heading text-center" style="margin-bottom: 10px; height: 50px">
        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" style="background-color: #d9edf7; border: none; color: #31708f; font-size: large">PUNCH OUT</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">What have you accomplished today?</h4>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="out.php">
                            <textarea class="form-control" rows="2" name="data" ></textarea>
                        </form>
                        <form method="post" action="inout.php">
                            <input type="submit" data-toggle="modal" data-tireget="#mymodal" class="btn btn-outline-success custom-control-input " style="background-color:#d9edf7;font-size: large" name="out" value="OK">
                        </form>
                    </div>
                </div>
